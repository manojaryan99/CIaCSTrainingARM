...
$subscriptionId = "efb1472b-cd11-42ea-9017-41ab0c915c56" #insert your subscription ID
$resourceGroupName = "CIaCS-rg-manoj"  #provide resource group name
...
$templateFileURI = 'https://raw.githubusercontent.com/manojaryan99/CIaCSTrainingARM/main/ContosoFinance-Demo-ARM/ARM-Templates/template.json'
$parametersFileURI = 'https://raw.githubusercontent.com/manojaryan99/CIaCSTrainingARM/main/ContosoFinance-Demo-ARM/ARM-Templates/paramters.json'
